 ...
 *  K线图最小的宽度
 */
#define Y_StockChartKLineMinWidth 0.5
...
//#define Y_StockChartKLineMainViewMaxY (self.frame.size.height )
...
//分时走势种类
typedef NS_ENUM(NSInteger, Y_StockTimeLineType) {
    Y_StockTimeLine_OneDay= 1, //
    Y_StockTimeLine_FiveDay,  //5日
    Y_StockTimeLine_Other
};

//K线走势种类
typedef NS_ENUM(NSInteger, Y_StockKLineType) {
...
//显示股票种类
typedef NS_ENUM(NSInteger, Y_StockType) {
    Y_StockType_AStock, //股票
    Y_StockType_Index,  //指数
    Y_StockType_Other
};
