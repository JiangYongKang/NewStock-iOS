...
@property (nonatomic,retain)UIColor *superColor;
@end
...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (currentOffsetY <= happenOffsetY){
        if(!((UIScrollView *)self.superview).header)
        {
            self.superview.backgroundColor = self.superColor;
        }
        return;
    }
...
//    }
    ...
    if (!CGColorEqualToColor(self.backgroundColor.CGColor, [UIColor clearColor].CGColor)) {
        ...
        {
            MJRefreshComponent *header = (MJRefreshComponent *)((UIScrollView *)self.superview).header;
            if (!CGColorEqualToColor(self.backgroundColor.CGColor, header.backgroundColor.CGColor))
            {
                self.superview.backgroundColor = self.backgroundColor;
            }
        }
