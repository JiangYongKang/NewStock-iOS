 ...
 */
typedef TKJDStatusBarStyle*(^TKJDPrepareStyleBlock)(TKJDStatusBarStyle *style);
 ...
 *  given class methods.
 */
@interface TKJDStatusBarNotification : NSObject
 ...
 */
+ (TKJDStatusBarView*)showWithStatus:(NSString *)status;
 ...
 */
+ (void)setDefaultStyle:(TKJDPrepareStyleBlock)prepareBlock;
...
+ (NSString*)addStyleNamed:(NSString*)identifier
                   prepare:(TKJDPrepareStyleBlock)prepareBlock;
 ...
 *  @param styleName 名称
 */
+(TKJDStatusBarStyle *)getStyle:(NSString *)styleName;
@end
