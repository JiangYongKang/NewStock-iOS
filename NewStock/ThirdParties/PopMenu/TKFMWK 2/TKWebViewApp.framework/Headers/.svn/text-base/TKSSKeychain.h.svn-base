...
typedef enum {
	/** No error. */
	TKSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	TKSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	TKSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	TKSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	TKSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	TKSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	TKSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	TKSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	TKSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	TKSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	TKSSKeychainErrorFailedToDecode = errSecDecode
} TKSSKeychainErrorCode;

extern NSString *const TKSSKeychainErrorDomain;

/** Account name. */
extern NSString *const TKSSKeychainAccountKey;
 ...
 */
extern NSString *const TKSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const TKSSKeychainClassKey;

/** Item description. */
extern NSString *const TKSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const TKSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const TKSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const TKSSKeychainWhereKey;
 ...
 */
@interface TKSSKeychain : NSObject
