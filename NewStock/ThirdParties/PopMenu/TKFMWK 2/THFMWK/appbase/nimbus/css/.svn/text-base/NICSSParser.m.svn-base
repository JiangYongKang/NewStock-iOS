...
- (NSDictionary *)mergeCompositeRulesets:(NSMutableArray *)compositeRulesets dependencyFilenames:(NSSet *)dependencyFilenames {
  ...
  if ([compositeRulesets count] == 1) {
    if ([dependencyFilenames count] > 0) {
        ...
        NSMutableDictionary *object = [compositeRulesets objectAtIndex:0];
        //[[compositeRulesets objectAtIndex:0] setObject:dependencyFilenames forKey:kDependenciesSelectorKey];
        [object setObject:dependencyFilenames forKey:kDependenciesSelectorKey];
    }
