...
+(NSInteger)intFromCssValues:(NSArray *)cssValues
{
    NIDASSERT([cssValues count] == 1);
    return [[cssValues objectAtIndex:0] intValue];
}

+(BOOL)boolFromCssValues:(NSArray *)cssValues
{
    NIDASSERT([cssValues count] == 1);
    return [[cssValues objectAtIndex:0] boolValue];
}
...
+(CGFloat)floatFormCssValues:(NSArray *)cssValues
{
    NIDASSERT([cssValues count] == 1);
...
RULE_ELEMENT(adjustsFontSize,AdjustsFontSize,@"-ios-adjusts-font-size",BOOL,boolFromCssValues)
RULE_ELEMENT(minimumFontSize,MinimumFontSize,@"-ios-minimum-font-size",CGFloat,floatFormCssValues)
RULE_ELEMENT(numberOfLines,NumberOfLines,@"-ios-number-of-lines",NSInteger,intFromCssValues)
RULE_ELEMENT(opacity,Opacity,@"opacity",CGFloat,floatFormCssValues)
RULE_ELEMENT(borderRadius,BorderRadius,@"border-radius",CGFloat,floatFormCssValues)
RULE_ELEMENT(textAlignment,TextAlignment,@"text-align",NSTextAlignment,textAlignmentFromCssValues)
...
RULE_ELEMENT(selectedBackgroundImage,SelectedBackgroundImage,@"-ios-selected-background-image", NSString*,imageStringFromCssValues)
...
RULE_ELEMENT(textColor, TextColor, @"color", UIColor*,colorFromCssValues)
RULE_ELEMENT(selectedTextColor, SelectedTextColor, @"-ios-selected-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(highlightedTextColor, HighlightedTextColor, @"-ios-highlighted-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(textShadowColor, TextShadowColor, @"text-shadow", UIColor*,colorFromCssValues)
RULE_ELEMENT(backgroundColor, BackgroundColor, @"background-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(selectedBackgroundColor, SelectedBackgroundColor, @"-ios-selected-background-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(indicatorColor, IndicatorColor, @"-ios-indicator-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(indicatorLineColor, IndicatorLineColor, @"-ios-indicator-line-color", UIColor*,colorFromCssValues)

RULE_ELEMENT(tintColor, TintColor, @"-ios-tint-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(barTintColor, BarTintColor, @"-ios-bar-tint-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(barTitleColor, BarTitleColor, @"-ios-bar-title-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(navStateBarColor, NavStateBarColor, @"-nav-state-bar-color", UIColor*,colorFromCssValues)
RULE_ELEMENT(navStateBarImage, NavStateBarImage, @"-nav-state-bar-image", NSString*,imageStringFromCssValues)
...
{
    return [[self class] colorFromCssValues:cssValues numberOfConsumedTokens:nil];
}
