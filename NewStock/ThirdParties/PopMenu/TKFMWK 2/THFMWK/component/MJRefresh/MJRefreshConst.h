...
// 图片路径
#define MJRefreshSrcName(file) [@"TKAsset.bundle/system/asset/MJRefresh" stringByAppendingPathComponent:file]
#define MJRefreshFrameworkSrcName(file) [@"Frameworks/MJRefresh.framework/TKAsset.bundle/system/asset/MJRefresh" stringByAppendingPathComponent:file]
