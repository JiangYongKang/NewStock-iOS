...
//    [[self layer] setBorderColor:[UIColor colorWithRed:195.0/255.0 green:195.0/255.0 blue:195.0/255.0 alpha:1.0].CGColor];
...
- (void)setSelectionIndicatorBoxCornerRadius:(CGFloat)selectionIndicatorBoxCornerRadius {
    ...
    self.selectionIndicatorBoxLayer.cornerRadius = selectionIndicatorBoxCornerRadius;
}

- (void)setSelectionIndicatorBoxMaskToBouns:(BOOL)selectionIndicatorBoxMaskToBouns {
    _selectionIndicatorBoxMaskToBouns = selectionIndicatorBoxMaskToBouns;
    
    self.selectionIndicatorBoxLayer.masksToBounds = selectionIndicatorBoxMaskToBouns;
}
