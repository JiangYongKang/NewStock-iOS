...
@interface TaoDeepStockViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TaoDeepStockViewController
...
- (void)loadData {
    self.listAPI.date = self.dateStr;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setN:model.n s:model.s t:model.t zx:buy zdf:model.zdf];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [NativeUrlRedirectAction nativePushToTigetStock:model.n s:model.s t:model.t m:model.m d:self.dateStr];
}
